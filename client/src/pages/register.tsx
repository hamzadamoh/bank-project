                ...
                <div className="max-w-md mx-auto">
                    ...
                    <div className="text-center mb-8">
                        <div className="inline-flex items-center justify-center w-16 h-16 bg-ink-950 rounded-2xl mb-6">
                            <User className="h-8 w-8 text-alabaster-50" />
                        </div>
                        <h1 className="font-display font-bold text-3xl text-ink-950 mb-2">
                            Create your account
                        </h1>
                        <p className="text-slate-600">
                            Join FiscAI and transform your finance workflow
                        </p>
                    </div>
                    ...
                    <GlassCard className="p-8">
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div>
                                <Label htmlFor="confirmPassword" className="text-sm font-medium text-ink-950">
                                    Confirm Password
                                </Label>
                                <div className="relative mt-1">
                                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-400" />
                        ...
                        <p className="text-center text-sm text-slate-600 mt-6">
                            ...
                            <Link href="/login" className="text-ink-950 font-semibold hover:underline">
                                Sign in
                            </Link>
                        </p>
                    </GlassCard>
